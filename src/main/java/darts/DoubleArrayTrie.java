...
public class DoubleArrayTrie {
	...
	public static class TrieTree{
        ...
        public static void main(String[] args) throws Exception{
            DoubleArrayTrie dat= loadWordList("test.csv");
            System.out.println(dat.getSize());
            if (dat.exactMatchSearch("北京") == -1){
                throw new RuntimeException("darts没找到该有的词");
            }else {
                System.out.println(dat.commonPrefixSearch("吉林市"));
            }
        }
        public static DoubleArrayTrie loadWordList(String fileName) throws IOException {
